	...
	case Progress::Started:
		{
			...
			AddEntry(game->txQuest[83], item->name.c_str(), tl.name.c_str(), GetLocationDirName(sl.pos, tl.pos));
...
//=================================================================================================
bool Quest_FindArtifact::Load(HANDLE file)
{
